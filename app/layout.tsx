...
import { CommandMenu } from '@/interactive/Selectors/Command';
import { CommandMenuProvider } from '@/interactive/Selectors/Command/command-menu-context';
import { items } from '@/interactive/src/NavMenu';
            ...
            <CommandMenuProvider>
              <SidebarContentProvider>
                <SidebarProvider className='flex-1'>
                  <SidebarMain side='left' navItems={items} />
                  {children}
                  <Toaster />
                  {/* <ThemeSetter /> */}
                  <CommandMenu />
